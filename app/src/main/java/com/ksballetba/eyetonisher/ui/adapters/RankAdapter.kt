...
class RankAdapter(val mItems: MutableList<RankListBean.Item>,val mOnClickListener: HomeAdapter.ItemOnClickListener) : RecyclerView.Adapter<RankAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        fun bind(model: RankListBean.Item) {
    ...
    fun update(newData: List<RankListBean.Item>) {
        mItems.clear()
        mItems.addAll(newData)
        notifyDataSetChanged()
    }

    fun add(addData: List<RankListBean.Item>) {
